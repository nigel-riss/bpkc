...
<body>
  <header class="site-header">
    ...
    <div class="hero">
      ...
      <p class="hero__text">Основными направлениями нашей работы являются: проектирование, поставка, монтаж и мониторинг систем, обеспечивающих объекты энергией и комфортным микроклиматом.</p><a class="button" href="about.html">Подробнее</a>
    </div>
  </header>
  ...
  <section class="news">
    <header class="news__header">
      ...
      <p class="news__subtitle">Актуальные новости развития энергосберегающих технологий и объектов использующих возобновляемые источники электроэнергии</p>
          ...
          <article class="news-item">
            ...
            <div class="news-item__text-wrapper">
              ...
              <div class="news-item__content">
                ...
                <div class="news-item__text">Все тонкости и секреты установки солнечных панелей в нашей статье, их которой немало нового смогут узнать даже опытные электрики.</div>
  ...
  <footer class="site-footer">
    <header class="site-footer__header">
      ...
      <div class="site-footer__contacts"><a href="tel:+74012123456">+7 (4012) 12-34-56</a><a href="mailto:bpkc39@gmail.com">bpkc39@gmail.com</a></div>
    </header>
    <div class="copyrights">&copy;  <span class="copyrights--orange">Балтийский Проектно-Консалтинговый Центр</span> 2017. </div>
  </footer>
</body>